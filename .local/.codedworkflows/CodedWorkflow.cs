...
namespace RPA_AutoUpdateAnchor
{
    public partial class CodedWorkflow : CodedWorkflowBase
    {
        ...
        {
            _ = new System.Type[]{typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.UIAutomationNext.API.Contracts.IUiAutomationAppService), typeof(UiPath.Excel.Activities.API.IExcelService), typeof(UiPath.GSuite.Activities.Api.IGoogleConnectionsService)};
